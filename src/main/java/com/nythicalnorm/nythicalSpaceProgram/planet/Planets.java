...
public class Planets {
    ...
    public static Star SURIYAN = (Star) registerPlanet("suriyan", new Star(new PlanetAtmosphere(true, new Vector4f(1f,1f,1f, 1f), new Vector4f(1f,1f,1f, 0f), 200000, 1.0f, 1.0f),
    ...
    public static PlanetaryBody BUMI = registerPlanet("bumi", new PlanetaryBody(new OrbitalElements(
            ...
            5.1970176873649567284,2.8619013937171278172,6.2504793475201942954),
             // 31557600),
             new PlanetAtmosphere(true, new Vector4f(0.7215686274509804f,0.8235294117647058f,1f, 1.0f), new Vector4f(0.4823529411764706f,0.6705882352941176f,1f, 1.0f), 100000, 1.0f, 0.5f),
    ...
    public static PlanetaryBody NILA = registerPlanet("nila", new PlanetaryBody(new OrbitalElements(
            ...
            //2358720),
            new PlanetAtmosphere(false, new Vector4f(0f, 0f, 0f, 0f), new Vector4f(0f, 0f, 0f, 0f), 0, 1.0f, 0.1f),
